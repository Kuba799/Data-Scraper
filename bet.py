class BestBet:
    ...
    def __init__(self, game, date, book_home, odd_home, book_draw, odd_draw, book_away, odd_away):
        ...
        BestBet.margin_string = "{:.3f}".format(BestBet.margin)

    def get_best_bet(self):
        return self.game, self.date, self.book_home, self.odd_home, self.book_draw, self.odd_draw, self.book_away, \
               self.odd_away, BestBet.margin_string
